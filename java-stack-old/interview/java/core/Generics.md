<!-- TOC -->
* [Generics (Дженерики)](#generics-дженерики)
  * [Raw types](#raw-types)
  * [Как работает вывод типов? Type Inference](#как-работает-вывод-типов-type-inference)
  * [Как инстанцировать экземпляр generic типа?](#как-инстанцировать-экземпляр-generic-типа)
  ...
  * [Можно ли выбрасывать исключение generic-типа?](#можно-ли-выбрасывать-исключение-generic-типа)
  * [Дженерики в исключениях – что можно, а что нельзя?](#дженерики-в-исключениях--что-можно-а-что-нельзя)
  * [Как ограничить upcasting типа-параметра?](#как-ограничить-upcasting-типа-параметра)
  * [Что такое heap pollution?](#что-такое-heap-pollution)
  * [Как ограничивается тип generic параметра? (Bound)](#как-ограничивается-тип-generic-параметра-bound)
  * [Wildcard](#wildcard)
  * [PECS](#pecs-)
  * [Поиграем с дженериками](#поиграем-с-дженериками)
      * [Что можно добавить в `List<? extends Number> numbers = new ArrayList<>()`](#что-можно-добавить-в-list-extends-number-numbers--new-arraylist)
      * [Что можно добавить в `List<? super Number> numbers = new ArrayList<>()`](#что-можно-добавить-в-list-super-number-numbers--new-arraylist)
      * [Отличается ли `List<?>` от `List<? extends Object>?`](#отличается-ли-list-от-list-extends-object)
